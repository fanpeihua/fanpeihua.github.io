<!-- 渲染版本：/harness-books/book2/chapter-07-convergence-and-divergence.html -->
<!-- Rendered HTML: /harness-books/book2/chapter-07-convergence-and-divergence.html -->
...
这里还可以多加一个提醒。现实里很多后起系统既没有把运行时纪律做扎实，也没有把控制层显式化到位，而是走向第三种更容易上手、也更容易失控的路线：把越来越多的 bootstrap 文件、角色设定、技能说明和工作区文本堆进 prompt，试图靠“信息更全”弥补骨架不足。这类系统短期里常常显得能跑，长期里却容易同时暴露两类问题：token 烧得快，工作语义又不够稳。
